    ...
    <div class="row">
        <div class="col-md-9">
            <div class="fg-line form-group">
                <label class="fg-label control-label label_lpo">LPO &nbsp; <span style="color: red">*</span></label>
        ...
        <div class="col-md-3">
            <div style=" text-align: justify; margin-top: 1rem">
                <a class="btn btn-outline-info" style=" top: 10px !important;" data-bs-toggle="modal" data-bs-target="#add_lpo">Add LPO</a>
...
<script type="text/javascript">
    ...
    function fetchSupplierLPO(event) {
        ...
        let url = "{{ url('store/lpos/list?supplier_id=') }}"+supplierID+'&type=lpo';
        fetch(url).then(response=>response.json()).then(resp=>{
            let optionValue = '';
            if (resp.length === 0){
                 optionValue = '<option value="">There exists no LPO for Selected Supplier</option>';
            }else{
